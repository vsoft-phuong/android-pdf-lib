/*
 * $Id: PDFPage.java,v 1.5 2012/04/26 22:22:25 leonardovc Exp $
 *
...
public class PDFPage {
	 ...
	 * @throws Exception 
	 */
	public Bitmap getImage(int width, int height, RectF clip) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public Bitmap getImage(int width, int height, RectF clip,boolean drawbg, boolean wait) throws Exception {
		Log.i("IMAGE", "Width = " + width + " HEigth: " + height);		
		ImageInfo imageInfo = new ImageInfo(width, height, clip, Color.WHITE);

		Bitmap image = Bitmap.createBitmap(width, height, Config.RGB_565);


		PDFRenderer renderer = new PDFRenderer(this, imageInfo, image);
		//renderers.put(imageInfo, new WeakReference<PDFRenderer>(renderer));

/*
 * $Id: PDFImage.java,v 1.3 2012/04/03 16:53:25 julio.braga Exp $
 *
            ...
            if (sMaskObj != null) {
                if (sMaskObj.getType() == PDFObject.STREAM) {
                    try {
                        ...
                        print("ERROR: there was a problem parsing the mask for this object");
                        dump(obj);
                    ...
                    try {
                        ...
                        print("ERROR: there was a problem parsing the color mask for this object");
                        dump(obj);
                        ex.printStackTrace(System.out);
                    }
                }
